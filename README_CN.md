...
每个 [Release](https://github.com/gal-agent/gal-release/releases) 包含分平台压缩包。压缩包内的二进制是干净名称（`gal` / `galw`），平台信息只体现在压缩包文件名上。
...
- 🐛 **Bug 报告**：[提交 Issue](https://github.com/gal-agent/gal-release/issues/new?labels=bug)
- ✨ **功能建议**：[提交 Issue](https://github.com/gal-agent/gal-release/issues/new?labels=enhancement)
- 💬 **讨论 / 问答**：[发起讨论](https://github.com/gal-agent/gal-release/discussions)
...
- [所有版本](https://github.com/gal-agent/gal-release/releases)
